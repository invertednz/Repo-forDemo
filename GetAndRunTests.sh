...
if [[ $teststorun == "high" ]] ; then mvn -Dtest=com.example.project.Area1Tests#Area1Test1,com.example.project.Area1Tests#Area1Test2,com.example.project.Area1Tests#Area1Test3,com.example.project.Area1Tests#Area1Test4,com.example.project.Area1Tests#Area1Test5 test ; . ./PushResultsToAppsurify.sh  ; fi
